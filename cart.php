...
<body>	
	...
	<center><h1>cart items products</h1> </center>
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                if (mysqli_num_rows($result2) > 0) {
					...
					<button> <a href="payment.php?id=<?php echo $row['product_id']; ?>">buy</a></button>
            ...
            echo "You have not added any products to your cart yet.";
        }
